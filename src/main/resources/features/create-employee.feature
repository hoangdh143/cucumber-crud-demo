Feature: Create Employee
  Scenario: WITH ALL REQUIRED FIELDS IS SUCCESSFUL
    Given user want to create an employee with the following attributes
      ...
      | 100 | Rachel | Green | 1990-01-01 | 2009-01-01 | Permanment | rachel.green@fs.com|
    ...
    When user save the new employee 'WITH ALL REQUIRED FIELDS'
    ...
    Scenario Outline: <testCase> <expectedResult>
      ...
      When user save the new employee '<testCase>'
